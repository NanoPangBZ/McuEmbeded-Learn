...
public:
    ...
    void hidReportPress( KeyCode_t keycode );
    void hidReportRelease( KeyCode_t keycode );
    bool hidReportIsPress( KeyCode_t keycode );
    void hidReportReset();

    uint8_t* getReportBuffer( uint16_t* size );

private:
    uint8_t _hidReportBuffer[17];
};
